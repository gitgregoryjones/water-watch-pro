  ...
  return (
    <div className='flex flex-col gap-4'>
      ...
      <div className='grid grid-cols-2 md:grid-cols-3 gap-2 md:gap-8' >
        ...
        <Stats header={<div className='flex  gap-2 justify-center  items-center text-white h-full border-b-[white] text-xl md:text-2xl'><i className='fa fa-solid fa-envelope'></i>Emails </div>}>
        ...
        <Stats header={<div className='flex gap-2 justify-center items-center px-4 text-white h-full border-b-[white] text-3xl md:text-3xl'><i className='text-3xl fa fas fa-sms'></i>Twilio </div>}>
        <div className='flex flex-col'>
