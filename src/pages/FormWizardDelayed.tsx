...
const FormWizardDelayed = () => {
  ...
  const isClick2PointEnabled = false;
  const isClick2MapPart2Enabled = false;
  ...
  const mapPickerCenter = false ? pickedLocation : { lat: 39.5, lng: -98.35 };
  const mapPickerZoom = false ? 18 : 5;
